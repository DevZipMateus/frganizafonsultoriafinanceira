...
const AboutUs = () => {
  return (
    <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-organiza-white">
      <div className="container px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          <div className="space-y-4">
            ...
            <p className="text-organiza-dark/90 md:text-xl">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <div className="bg-organiza-dark p-4 rounded-lg">
                <h3 className="font-bold text-xl text-organiza-white">Missão</h3>
                <p className="text-organiza-light/80">
                  Ajudar empresas a organizarem suas finanças e alcançarem maior lucratividade.
                </p>
              </div>
              <div className="bg-organiza-accent p-4 rounded-lg">
                <h3 className="font-bold text-xl text-organiza-white">Visão</h3>
                <p className="text-organiza-light/80">
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-md h-60 sm:h-80 overflow-hidden rounded-lg">
              <div className="w-full h-full bg-organiza-highlight flex items-center justify-center text-center p-6">
                <p className="text-3xl font-semibold text-organiza-white italic">
